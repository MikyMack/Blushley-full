...
// GET route for staff login page
router.get('/staff/staffLogin', (req, res) => {
...
router.post("/staff/login/send-otp", staffCtrl.sendStaffLoginOtp);
...
router.get('/staff/reseller_products', async (req, res) => {
    try {
